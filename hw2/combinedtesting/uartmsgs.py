...
class UARTMsgs:
    ...
    # I would like to figure out later how to return values from asyncio in various ways.
    async def read(self):
        while True:
    ...
    async def main(self, duration):
        ...
        asyncio.create_task(self.sendstdin())	# send stdin task
